...
% x1 = first_vertical_point(1);
% z1 = first_vertical_point(3);

% x2 = last_middle_point(1);
% z2 = last_middle_point(3);

% Li_line = @(z_interp) x1+((z_interp-z1)*(x2-x1)/(z2-z1));
% disp(first_vertical_point)
% Li = Li_line(z)